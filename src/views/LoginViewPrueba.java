...
public class LoginViewPrueba extends JPanel {
	...
	/*
	 * public void imagenBoton() { ImageIcon iconoOriginal = new
	 * ImageIcon("src/image/logoboton.png");
	 * 
	 * Image imagenEscalada = iconoOriginal.getImage().getScaledInstance(50, 50,
	 * Image.SCALE_SMOOTH); ImageIcon iconoEscalado = new ImageIcon(imagenEscalada);
	 * 
	 * JButton boton = new JButton("INGRESAR", iconoEscalado); boton.setBounds(265,
	 * 555, 150, 50);
	 * 
	 * 
	 * add(boton); }
	...
	/*imagen
    ImageIcon iconoOriginal = new ImageIcon("src/image/logoventana.png");
